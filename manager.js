...
function riderAdminCard(r){
  ...
  const action=status==='PENDING_APPROVAL'?'<button class="btn btn-small" onclick="event.stopPropagation();approveRider(\''+r.id+'\',this)">APPROVE RIDER</button>':status==='ACTIVE'?'<button class="btn btn-small secondary" onclick="event.stopPropagation();suspendRider(\''+r.id+'\',this)">SUSPEND</button>':status==='SUSPENDED'?'<button class="btn btn-small" onclick="event.stopPropagation();reactivateRider(\''+r.id+'\',this)">REACTIVATE</button>':status==='INVITED'?'<button class="btn btn-small secondary" onclick="event.stopPropagation();renewRiderInvite(\''+r.id+'\',this)">NEW INVITE LINK</button>':'';
